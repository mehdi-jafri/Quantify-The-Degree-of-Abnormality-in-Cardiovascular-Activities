...
b1=Button(root,text="MIMIC-IV Waveform Database",command=b1,bg="red",fg="white",font = "Helvetica 13 bold italic")
...
b2=Button(root,text="Quasi-residue Empirical Gradient Filter-based Pre-processing ",command=b2,bg="red",fg="white",font = "Helvetica 13 bold")
...
b3=Button(root,text="Fractal Dimension_TD_Product-to-sum Fourier_FD_Feature Extraction",command=b3,bg="red",fg="white",font = "Helvetica 13 bold")
...
b31=Button(root,text="Batch Normalized Auto-encoder Threshold_Outlier Detection Quantifier ",command=b31,bg="red",fg="white",font = "Helvetica 13 bold")
...
l2=tk.Label(root,text="Performance Analysis",fg = "white",bg = "red",font = "Helvetica 16 bold")
l2.place(x=980,y=400)

b4=Button(root,text=" MAE of outlier detection (%)",command=b4,bg="red",fg="white",font = "Helvetica 13 bold")
b4.place(x=800,y=450)
b4.configure(width=45,height=1)

b5=Button(root,text="Precision, Recall and Accuracy",command=b5,bg="red",fg="white",font = "Helvetica 13 bold")
b5.place(x=800,y=500)
b5.configure(width=45,height=1)

b6=Button(root,text="F1-score",command=b6,bg="red",fg="white",font = "Helvetica 13 bold")
...
tk.Label(root, 
		 ...
		 fg = "white",
		 bg = "red",
		 font = "Helvetica 13 bold").pack(pady=1,padx=0)
tk.Label(root, 
